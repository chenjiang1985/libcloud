...
class OSSConnection(ConnectionUserAndKey):
    ...
    def request(self, action, params=None, data=None, headers=None,
                method='GET', raw=False, container=None, stream=False):

        self.host = self.driver._endpoint
...
class OSSStorageDriver(StorageDriver):
    ...
    def __init__(self, endpoint,  key, secret=None,  secure=True, host=None, port=None,
                 api_version=None, region=None, **kwargs):
        self._endpoint = endpoint
        super(OSSStorageDriver, self).__init__(key, secret=secret, secure=secure,
                                               host=host, port=port, api_version=api_version,
                                               region=region, kwargs=kwargs)
    ...
    def download_object_as_stream(self, obj, chunk_size=None):
        ...
        response = self.connection.request(obj_path,
                                           method='GET',
                                           raw=True,
                                           container=obj.container, stream=True)
    ...
    def _put_object(self, container, object_name, method='PUT',
        ...
        result_dict = self._upload_object(
            ...
            headers=headers, file_path=file_path, stream=stream, container=container)
        ...
        if (verify_hash and result_dict['data_hash'].lower() != server_hash.lower()):
